...
auditwheel repair --plat manylinux2014_x86_64 dist/pygloo-0.1.0-cp36-cp36m-linux_x86_64.whl
bazel clean --expunge
...
auditwheel repair --plat manylinux2014_x86_64 dist/pygloo-0.1.0-cp37-cp37m-linux_x86_64.whl
bazel clean --expunge
...
auditwheel repair --plat manylinux2014_x86_64 dist/pygloo-0.1.0-cp38-cp38-linux_x86_64.whl
bazel clean --expunge
